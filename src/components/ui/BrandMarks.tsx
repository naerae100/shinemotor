 ...
 *
 * lucide-react 1.x removed its brand icons, so these are drawn here rather than
 * pulled from a package. They inherit `currentColor` like every other icon on
 * the site, except <GoogleMark />, which is locked to Google's four brand
 * colours — a recoloured Google "G" is a trademark problem, and a monochrome
 * one next to a review reads as generic.
 *
 * Each is a single path at a 24-unit viewBox so they size like Lucide icons.
 */
...
/** Google's "G". Fixed brand colours — do not recolour or set currentColor. */
