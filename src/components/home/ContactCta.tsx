        ...
        <Reveal stagger className="mx-auto mt-12 grid max-w-4xl gap-4 sm:grid-cols-3">
          <RevealItem distance={16}>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex h-full flex-col items-center rounded-2xl border border-[#25D366]/35 bg-[#25D366]/[0.07] p-7 text-center transition-colors hover:border-[#25D366]"
            >
          ...
          <RevealItem distance={16}>
            <a
              ...
              className="flex h-full flex-col items-center rounded-2xl border border-hairline bg-surface p-7 text-center transition-colors hover:border-flame"
            >
              <span className="grad-flame flex size-12 items-center justify-center rounded-full">
                <Phone aria-hidden className="size-6 text-white" strokeWidth={2.25} />
              </span>
          ...
          <RevealItem distance={16}>
            <Link
              ...
              className="flex h-full flex-col items-center rounded-2xl border border-hairline bg-surface p-7 text-center transition-colors hover:border-flame"
            >
              <span className="flex size-12 items-center justify-center rounded-full border border-hairline bg-void/60 font-display text-lg text-amber">
                ✎
              </span>
