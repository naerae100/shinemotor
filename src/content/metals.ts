...
export const familyImage: Record<Family, { src: string; alt: string }> = {
  Copper:     { src: '/img/buy/copper_scrap_1788318729220.jpg',    alt: 'Scrap copper wire and tubing for recycling at Shine Motor Corporation Ingleburn Sydney' },
  Brass:      { src: '/img/buy/brass_scrap_1788318742664.jpg',     alt: 'Mixed brass and gun metal scrap fittings bought at Shine Motor Corporation Ingleburn' },
  Aluminium:  { src: '/img/buy/aluminium_scrap_1788318766541.jpg', alt: 'Aluminium scrap including extrusions rims and castings recycled at Shine Motor Sydney' },
  Steel:      { src: '/img/buy/steel_scrap_1788318778283.jpg',     alt: 'Heavy and light gauge steel scrap for recycling at Shine Motor Corporation Ingleburn NSW' },
  Motor:      { src: '/img/buy/motor_scrap_1788318793266.jpg',     alt: 'Electric motors starters alternators and compressors bought for scrap in Sydney' },
  Radiator:   { src: '/img/buy/radiator_scrap_1788319024964.jpg',  alt: 'Copper brass and aluminium radiator cores for scrap recycling at Shine Motor Ingleburn' },
  'AC Units': { src: '/img/buy/ac_unit_scrap_1788319053531.jpg',   alt: 'Degassed air conditioning units for scrap recycling at Shine Motor Corporation Sydney' },
  Battery:    { src: '/img/buy/battery_scrap_1788319066022.jpg',   alt: 'Used lead-acid car and truck batteries for scrap recycling in Ingleburn NSW' },
  Lead:       { src: '/img/buy/lead_scrap_1788319079231.jpg',      alt: 'Soft lead scrap sheet pipe and flashing recycled at Shine Motor Corporation Sydney' },
}
